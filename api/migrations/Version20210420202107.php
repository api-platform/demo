...
final class Version20210420202107 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE book (id UUID NOT NULL, isbn VARCHAR(255) DEFAULT NULL, title VARCHAR(255) NOT NULL, description TEXT NOT NULL, author VARCHAR(255) NOT NULL, publication_date DATE NOT NULL, front_cover_filename VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
